...
if(isset($_SESSION['correoadmin'])) {
    ...
    exit();
  }else if (!isset($_SESSION['correocol'])) {
  echo 
  '<script>
  alert("Inicia sesión");
...
<head>
    ...
    <!-- Estilos -->
    <link rel="stylesheet" href="colaborador/css/estilos.css">
    <link rel="stylesheet" href="administrador/css/index.css">
    <title>Inicio</title>
</head>
<body>
   ...
   <div class="contenedor">
        ...
        <div class="bienvenido">
            <div class="contenidob">
                ...
                <h5 class="text-center">Ahora podrás dar tus servicios como profesional y ayudar a las personas sin importar la distancia.</h5>
            </div>
        </div>
        <!--Fin Bienvenido-->
        <!-- Contenedor 2 -->
        ...
        <div class="contenedorc">
            <div class="contenedor2 row align-columns-center">
                <div class="col-12 mt-5 border-top pt-4 pb-3">
                    <h2 class="text-center text-primary text-uppercase">Trabajando juntos</h2>
                    <p class="text-center">Existen diversos problemas y cada uno con ayuda especial y arduo trabajo ayudan a disminuirlo con tu ardua participación lograremos el objetivo de nuestro sitio web. Puedes ofrecer tus servicios virtual, presencialmente o de ambas formas.</p>
                </div>
                    <div class="card col bg-transparent border-0 border-bottom pb-4 rounded-0 ">
                        ...
                        <h4 class="card-title text-center pt-3">Oportunidades</h4>
                        <p class="card-text text-justify pt-2">Pueden contactarse contigo y empezar a trabajar con tus pacientes</p>
                    </div>

                    <div class="card col bg-transparent border-0 border-bottom pb-4  rounded-0">
                        <img src="img/elementos/saludmental.jpg" alt="" class="card-img-top img-fluid">
                        <h4 class="card-title text-center pt-3">Tratamientos</h4>
                        <p class="card-text text-justify pt-1">Como profesional puedes ofrecer tratamientos sin embargo necesitas una revisión exhaustiva dependiendo el tipo de servicio que estés brindando.</p>
                    </div>
            </div>
        </div>
        <!-- fin -->
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-5 order-lg-1">
                        <div class="p-4">
                            <h3 class="display-5">Funciones</h3>
                            <h5  style="text-align:center ;" >Como colaborador las funciones que necesitas solo es contactar con los pacientes que requieran de tu servicio por lo cual tus funciones como usuario se han modificado.</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-6"><img class="img-fluid rounded-circle" src="img/elementos/fondoi.jpg" alt="" />
                            <div class="d-grid gap-1 d-md">
                                <button type="button" class="btn btn-outline-primary"><a href="#" >Empezar ahora</a></button>
                              </div>
                        </div>
                    </div>
                    <div class="col-lg-5 order-lg-2"  >
                        <div class="p-5">
                            ...
                            <h5 class="display-6" style="text-align:center; ;">Puedes verificar quienes te han contactado</h5>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-4 my-5 border-top">
    <div class="col-md-4 d-flex align-items-center">
      <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
        <svg class="bi" width="50" height="24"><use xlink:href="#bootstrap"/></svg>
      </a>
      <span class="mb-3 mb-md-0 text-muted">&copy; 2022 Company, Inc</span>
    </div>

    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      <li class="ms-3"><a class="text-info" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#twitter"/></svg></a></li>
      <li class="ms-3"><a class="text-danger" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#instagram"/></svg></a></li>
      <li class="ms-3"><a class="text-primary" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#facebook"/></svg></a></li>
    </ul>
  </footer>
    </div> -->
    <!-- Fin contenedor todo -->
