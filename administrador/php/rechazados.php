...
$sql = $con ->prepare("SELECT * FROM colaborador col INNER JOIN persona per ON col.id_persona = per.id_persona WHERE `admin` = 2");
    $sql->execute();
...
<nav class="menu">
   ...
   <!-- CONTENIDO -->
   <div class="info">
                <h3 class="text-center text-light bg-danger pt-3 display-5 pb-3" style="font-variant:small-caps;"> <i class="fa-solid fa-user-xmark"></i> Psicologos Rechazados</h3>
            </div>
        <div class="container">
        <?php
